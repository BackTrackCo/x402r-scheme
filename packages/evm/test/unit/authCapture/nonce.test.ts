...
import { computeAuthCaptureNonce, generateSalt } from '../../../src/authCapture/shared/nonce'

describe('nonce utilities', () => {
  describe('computeAuthCaptureNonce', () => {
    ...
    it('should produce a 32-byte hex string', () => {
      ...
      const nonce = computeAuthCaptureNonce(chainId, escrowAddress, mockPaymentInfo)
    ...
    it('should produce deterministic results for same inputs', () => {
      ...
      const nonce1 = computeAuthCaptureNonce(chainId, escrowAddress, mockPaymentInfo)
      const nonce2 = computeAuthCaptureNonce(chainId, escrowAddress, mockPaymentInfo)
    ...
    it('should produce different results for different chainIds', () => {
      ...
      const nonce1 = computeAuthCaptureNonce(84532, escrowAddress, mockPaymentInfo)
      const nonce2 = computeAuthCaptureNonce(8453, escrowAddress, mockPaymentInfo)
    ...
    it('should produce different results for different escrow addresses', () => {
      ...
      const nonce1 = computeAuthCaptureNonce(
        chainId,
        '0x5555555555555555555555555555555555555555' as const,
        mockPaymentInfo,
      )
      const nonce2 = computeAuthCaptureNonce(
        chainId,
    ...
    it('should produce different results for different payment info', () => {
      ...
      const nonce1 = computeAuthCaptureNonce(chainId, escrowAddress, mockPaymentInfo)
      const nonce2 = computeAuthCaptureNonce(chainId, escrowAddress, {
        ...mockPaymentInfo,
        maxAmount: '2000000',
      })
