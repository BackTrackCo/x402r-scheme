...
Standard x402 facilitator that exposes `POST /verify`, `POST /settle`, and `GET /supported`, with the [auth-capture](../../../specs/schemes/auth-capture/scheme_auth_capture_evm.md) scheme registered for Base Sepolia (`eip155:84532`).
